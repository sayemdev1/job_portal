						...
						<div class="col-md-12">
							<div class="team d-md-flex p-4 bg-white">
								...
								<div class="text pl-md-4">
									<span class="location mb-0"><?php echo $result['location']?></span>
									<h2><?php echo $result['name']?></h2>
									<span class="position"><?php echo $result['experience']?></span>
									<p class="mb-2"><?php echo $result['about']?></p>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">JOB-PORTAL</h2>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
